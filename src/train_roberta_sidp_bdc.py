...
for test_file in list_of_files:
    ...
    for file in train_files:
        ...
        if os.path.exists(file):
            ...
            sidp_df = pd.read_csv('../data/SPAN_baseline_DSM_PDs_Newscoring.csv')
            ...
            train_data = train_data[train_data['SIDPBDC'] != '.'] 
            ...
            train_labels = train_data['SIDPBDC'].astype(float).tolist()
    ...
    if os.path.exists(test_file):
        ...
        sidp_df = pd.read_csv('../data/SPAN_PDs_Top3.csv')
        ...
        # Preprocess and standardize labels
        test_data = test_data[test_data['SIDPBDC'] != '.']
        # scaler = StandardScaler()
        ...
        test_labels = test_data['SIDPBDC'].astype(float).tolist()
    ...
    model_save_path = './Atext/'+str(re.findall(r'\d', str(test_file))[0])+'_'+str(patience)+'/'
